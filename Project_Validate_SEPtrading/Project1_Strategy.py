    ...
    def on_data_update(self, data):
        if data.type == "Bar_1day":
            ...
            if data.date in self.Trade_date:
                ...
                self.t1 =  self.add_alarm(chrono.str_to_time(str(cal.add(data.date, 1))+"01:31:00.000000"))
                self.t2 =  self.add_alarm(chrono.str_to_time(str(cal.add(data.date, 1))+"01:37:00.000000"))
                self.t3 =  self.add_alarm(chrono.str_to_time(str(cal.add(data.date, 1))+"01:43:00.000000"))
                self.t4 =  self.add_alarm(chrono.str_to_time(str(cal.add(data.date, 1))+"01:49:00.000000"))
                self.t5 =  self.add_alarm(chrono.str_to_time(str(cal.add(data.date, 1))+"01:55:00.000000"))
